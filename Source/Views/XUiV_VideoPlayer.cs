...
namespace Views
{
    public class XUiV_VideoPlayer : XUiView
    {
        ...
        public override void InitView()
        {
            ...
            ModEvents.GameShutdown.RegisterHandler((ref ModEvents.SGameShutdownData data) => OnShutdown());
        }
        ...
        {
            base.Cleanup();
            ModEvents.GameShutdown.UnregisterHandler((ref ModEvents.SGameShutdownData data) => OnShutdown());
            Stop();
        }
